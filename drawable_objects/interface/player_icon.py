...
class PlayerIcon(SpriteObject):
    ...
    def __init__(self, scene: Scene, controller: Controller, player: Player):
        super().__init__(scene, controller, PlayerIcon.IMAGES[0], Point(0, 0), 0, PlayerIcon.IMAGE_ZOOM)
        self.player = player
        self.left_corner_to()
    ...
    def left_corner_to(self, pos: Point = 0):
        ...
        height = ImageManager.get_height(self.image_name, PlayerIcon.IMAGE_ZOOM)
