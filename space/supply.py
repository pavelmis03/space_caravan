...
class Supply:
    ...
    Это также удобное хранилище тех данных, которые нужны на всех сценах. Например, здесь хранятся данные о планетах,
    нужные и на карте планет, и на главной сцене уровня.
    """
    START_FUEL = 0
    START_ESSENCE = 0
