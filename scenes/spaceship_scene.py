...
class SpaceshipScene(GameScene):
    def __init__(self, game):
        ...
        player_spawn_point = Point((top_left_cornor_bias + 2) * 25, (top_left_cornor_bias + 2) * 25)
        room_width = 30
        room_height = 20
        terminal_spawn_point = player_spawn_point + Point((room_width / 2 - 2) * 25, (room_height - 3) * 25)
        ...
        self.grid = SpaceshipGrid(self, self.game.controller, Point(0, 0), 25, 25, room_width, room_height, top_left_cornor_bias)
        self.game_objects.append(SpaceMapTerminal(self, self.game.controller, terminal_spawn_point, 0))
